...
use crate::hop::semantics::annotation::TypeAnnotation;
...
pub fn typecheck_expr(
    ...
    match parsed_expr {
        ...
        ParsedExpr::BinaryOp {
            ...
            let typed_left =
                typecheck_expr(left, var_env, type_env, annotations, definition_links, None)
                    .or_else(|left_err| {
        ...
        ParsedExpr::RecordLiteral {
            ...
            let (record_type, def_range) =
                type_env.lookup(record_name.as_str()).ok_or_else(|| {
        ...
        while tokenizer::peek_past_comments(&iter).is_some() {
            ...
            match declaration {
                ParsedDeclaration::Enum {
                    ...
                    let _ = type_env.push(name.to_string(), (Arc::new(enum_type), name_range));
                }
                ParsedDeclaration::Record {
                    ...
                    let _ = type_env.push(name.to_string(), (Arc::new(record_type), name_range));
                }
