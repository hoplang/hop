...
pub struct AppState {
    ...
    pub tailwind_css: Arc<RwLock<String>>,
}
...
mod tests {
    ...
    fn create_test_server(input: &str) -> TestServer {
        ...
        let app_state = AppState {
            ...
            reload_channel,
            tailwind_css: Arc::new(RwLock::new(String::new())),
        };
    ...
    async fn should_correctly_render_a_component_with_props() {
        ...
        expect![[r#"<!DOCTYPE html><html><head><meta charset="utf-8"><meta content="width=device-width, initial-scale=1" name="viewport"><style></style></head><body><h1>Welcome</h1><p>Hello, Alice!</p></body></html>"#]]
    ...
    async fn should_correctly_render_a_component_without_props() {
        ...
        response.assert_status_ok();
        expect![[r#"<!DOCTYPE html><html><head><meta charset="utf-8"><meta content="width=device-width, initial-scale=1" name="viewport"><style></style></head><body><div>Simple content</div></body></html>"#]]
        .assert_eq(&response.text());
    }
    ...
    async fn should_correctly_render_a_component_that_references_a_component_in_another_module() {
        ...
        response.assert_status_ok();
        expect![[r#"<!DOCTYPE html><html><head><meta charset="utf-8"><meta content="width=device-width, initial-scale=1" name="viewport"><style></style></head><body><div><button>Click me</button></div></body></html>"#]]
        .assert_eq(&response.text());
    }
