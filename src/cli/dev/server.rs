...
mod tests {
    ...
    async fn should_correctly_render_a_component_without_props() {
        ...
        response.assert_status_ok();
        expect![[r#"<!DOCTYPE html><html><head><meta charset="utf-8"><meta content="width=device-width, initial-scale=1" name="viewport"></head><body><div>Simple content</div></body></html>"#]]
        .assert_eq(&response.text());
    }
    ...
    async fn should_correctly_render_a_component_that_references_a_component_in_another_module() {
        ...
        response.assert_status_ok();
        expect![[r#"<!DOCTYPE html><html><head><meta charset="utf-8"><meta content="width=device-width, initial-scale=1" name="viewport"></head><body><div><button>Click me</button></div></body></html>"#]]
        .assert_eq(&response.text());
    }
