                ...
                view Test() {
                  let inner = Option[String]::Some("hello") in {
                    let mapped = match inner {
                      Some(v_1) => let x = v_1 in Option[String]::Some(x),
            ...
            expect![[r#"
                ...
                view Test() {
                  let result = Outcome::Success {value: "hello"} in {
                    match result {
                      Outcome::Success(value: v_1) => {
                        let v = v_1 in {
                          write("Ok:")
                          write_escaped(v)
                        }
                      }
                      Outcome::Failure(message: v_2) => {
                        let m = v_2 in {
                          write("Err:")
                          write_escaped(m)
                        }
            ...
            expect![[r#"
                ...
                view Test() {
                  let resp = Response::Win {code: "200", body: "OK"} in {
                    match resp {
                      Response::Win(code: v_1, body: v_2) => {
                        let c = v_1 in {
                          let b = v_2 in {
                            write_escaped(c)
                            write(":")
    ...
    fn nested_option_match() {
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v_1 = Option[String]::Some("deep") in {
                    match v_1 {
                      Some(v_2) => {
                        let x = v_2 in {
                          write_escaped(x)
    ...
    fn nested_option_wildcard_inner() {
        ...
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v_1 = Option[String]::Some("x") in {
                    match v_1 {
                      Some(_) => {
                        write("some-some")
                      }
    ...
    fn triple_nested_option_wildcard() {
        ...
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v_1 = Option[Option[String]]::Some(Option[String]::Some("value")) in {
                    match v_1 {
                      Some(v_2) => {
                        match v_2 {
                          Some(_) => {
    ...
    fn nested_match_statements_with_variable_subjects() {
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v_1 = Option[String]::Some("hello") in {
                    let inner = v_1 in {
                      match inner {
                        Some(v_3) => {
                          let value = v_3 in {
            ...
            expect![[r#"
                ...
                view Test() {
                  let target = Option[test::Target]::Some(Target {
                    ...
                    let items = [
                      match target {
                        Some(v_1) => let t = v_1 in Option[String]::Some(t.title),
                        None => Option[String]::None,
                      },
                    ] in {
                      for item in items {
