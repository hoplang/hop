                ...
                view Test() {
                  let inner = Option[String]::Some("hello") in {
                    let mapped = match inner {
                      Some(v__1) => let x = v__1 in Option[String]::Some(x),
    ...
    fn record_match_on_expression_subject() {
        check(
            ...
            expect![[r#"
                ...
                view Test() {
                  let result = let v__0 = Point {
                    x: "hi",
                    y: "bye",
                  } in let v__1 = v__0.x in let a = v__1 in a in {
                    write("got:")
                    write_escaped(result)
                  }
                }
            ...
            expect![[r#"
                ...
                view Test() {
                  let shape = Shape::Rect {height: "b", width: "a"} in {
                    match shape {
                      Shape::Rect(width: v__1, height: v__2) => {
                        let w = v__1 in {
                          let h = v__2 in {
                            write_escaped(w)
                            write("-")
            ...
            expect![[r#"
                ...
                view Test() {
                  let result = Outcome::Success {value: "hello"} in {
                    match result {
                      Outcome::Success(value: v__1) => {
                        let v = v__1 in {
                          write("Ok:")
                          write_escaped(v)
                        }
                      }
                      Outcome::Failure(message: v__2) => {
                        let m = v__2 in {
                          write("Err:")
                          write_escaped(m)
                        }
    ...
    fn enum_with_fields_match_on_expression_subject() {
        check(
            ...
            expect![[r#"
                ...
                view Test() {
                  let result = match Outcome::Success {value: "hi"} {
                    Outcome::Success {value: v__1} => let v = v__1 in v,
                    Outcome::Failure {message: v__2} => let m = v__2 in m,
                  } in {
                    write("got:")
                    write_escaped(result)
                  }
            ...
            expect![[r#"
                ...
                view Test() {
                  let resp = Response::Win {code: "200", body: "OK"} in {
                    match resp {
                      Response::Win(code: v__1, body: v__2) => {
                        let c = v__1 in {
                          let b = v__2 in {
                            write_escaped(c)
                            write(":")
    ...
    fn nested_option_match() {
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v__1 = Option[String]::Some("deep") in {
                    match v__1 {
                      Some(v__2) => {
                        let x = v__2 in {
                          write_escaped(x)
    ...
    fn nested_option_wildcard_inner() {
        ...
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v__1 = Option[String]::Some("x") in {
                    match v__1 {
                      Some(_) => {
                        write("some-some")
                      }
    ...
    fn triple_nested_option_wildcard() {
        ...
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v__1 = Option[Option[String]]::Some(Option[String]::Some("value")) in {
                    match v__1 {
                      Some(v__2) => {
                        match v__2 {
                          Some(_) => {
    ...
    fn nested_match_statements_with_variable_subjects() {
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v__1 = Option[String]::Some("hello") in {
                    let inner = v__1 in {
                      match inner {
                        Some(v__3) => {
                          let value = v__3 in {
            ...
            expect![[r#"
                ...
                view Test() {
                  let tree = Tree::Node {label: "a", left: Tree::Leaf, right: Option[test::Tree]::None} in {
                    match tree {
                      Tree::Node(label: v__1, left: v__2, right: v__3) => {
                        let l = v__1 in {
                          let lt = v__2 in {
                            let r = v__3 in {
            ...
            expect![[r#"
                ...
                view Test() {
                  let c = Contact::Email {address: "a@b.c", label: Option[String]::Some("work")} in {
                    match c {
                      Contact::Email(address: v__1, label: v__2) => {
                        let a = v__1 in {
                          let l = v__2 in {
                            write_escaped(a)
                            match l {
            ...
            expect![[r#"
                ...
                view Test() {
                  let i__0 = Item::Todo {label: "Buy milk", done: true} in {
                    let item = i__0 in {
                      match item {
                        Item::Todo(label: v__1, done: v__2) => {
                          let l = v__1 in {
                            let d = v__2 in {
                              match d {
                                true => {
                  ...
                  let i__0 = ButtonElement::Button {disabled: false, type: "submit"} in {
                    let el = i__0 in {
                      match el {
                        ...
                        ButtonElement::Button(type: v__3) => {
                          let t = v__3 in {
                            write("<button")
                            write(" type=\"")
                            write_escaped(t)
            ...
            expect![[r#"
                ...
                view Test() {
                  let target = Option[test::Target]::Some(Target {
                    ...
                    let items = [
                      match target {
                        Some(v__1) => let t = v__1 in Option[String]::Some(t.title),
                        None => Option[String]::None,
                      },
                    ] in {
                      for item in items {
            ...
            expect![[r#"
                  ...
                  match (0 < depth) {
                    true => {
                      ...
                      let v__1 = {
                        ...
                        call Nest(depth = (depth - 1), children = v__1)
                      }
                      write("</div>")
                    }
                    false => {
                ...
                view Test() {
                  let v__2 = {
                    ...
                    call Nest(depth = 2, children = v__2)
                  }
                }
                -- ir (optimized) --
                component Nest(depth: Int, children: Fragment) {
    ...
    fn nested_option_bool_literal_patterns() {
        check(
            ...
            expect![[r#"
                ...
                -- ir (optimized) --
                view Test() {
                  let v__1 = Option[Bool]::Some(true) in {
                    match v__1 {
                      Some(v__2) => {
                        match v__2 {
                          true => {
